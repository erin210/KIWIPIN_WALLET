...
// const CLOUDFRONT_MAIN = env === 'stage'
//     ? process.env.CLOUDFRONT_STAGE_MAIN || null
//     : process.env.CLOUDFRONT_PROD_MAIN || null;

// const CLOUDFRONT_T = env === 'stage'
//     ? process.env.CLOUDFRONT_STAGE_T || null
//     : process.env.CLOUDFRONT_PROD_T || null;
...
// ===== 5. CloudFront 清除快取 =====
// async function invalidateCloudFront(distributionIds) {
...
//             }
//         }).promise();
//         console.log(`♻️  CloudFront invalidated: ${distId}`);
//     }
// }
...
(async () => {
    try {
        ...
        // CloudFront 清除快取
        // const validDistributions = [CLOUDFRONT_MAIN, CLOUDFRONT_T].filter(Boolean);
        // if (validDistributions.length > 0) {
        //     await invalidateCloudFront(validDistributions);
        // } else {
        //     console.log('⚠️  No CloudFront distributions to invalidate.');
        // }
